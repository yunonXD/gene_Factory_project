...
public class BattleStage1_2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Skilleffect_2.Stop();
        //EnemyReset();                                                       //적 위치 및 
        enemyDamage = enemy.GetComponent<Enemy_Silme>().Power - player.GetComponent<FrancScript>().Defense;            //적  공격대미지
        _enemyDamage = Boss.GetComponent<NimpueScript>().Power - player.GetComponent<FrancScript>().Defense;
        playerDamage = player.GetComponent<FrancScript>().Power - enemy.GetComponent<Enemy_Silme>().Defense;           //플레이어 공격대미지
        _playerDamage = player.GetComponent<FrancScript>().Power - Boss.GetComponent<NimpueScript>().Defense;
        Player_HPMax = player.GetComponent<FrancScript>().HP;
        Debug.Log(Player_HPMax);
        Enemy_HPMax = enemy.GetComponent<Enemy_Silme>().HP;
        Boss_HPMax = Boss.GetComponent<NimpueScript>().HP;
    ...
    void MovePlayer_Mob()     //잡몹 스테이지 시작시 플레이어 활성화,이동모션 및 이동
    {
        ...
        player.GetComponent<FrancScript>().walk();
    ...
    void Characterstartmove_Boss()  //체크 1번
    {
        ...
        player.GetComponent<FrancScript>().walk_3();
    }
    ...
    void Update()
    {
        if (MobClear == false && _GameOver == false)  //잡몹 전투
        {
            ...
            Player_Hpbar.fillAmount = player.GetComponent<FrancScript>().HP / Player_HPMax;
        ...
        else if (MobClear == true && _GameOver == false)        //보스 전투
        {
            ...
            {
                Player_Hpbar.fillAmount = player.GetComponent<FrancScript>().HP / Player_HPMax;
                Enemy_HPbar.fillAmount = Boss.GetComponent<NimpueScript>().HP / Boss_HPMax;
                Skiil_Bar.fillAmount = skill;
            }
    ...
    void ClearMotion() //스테이지 클리어 모션연출      위치값 변경 위치#2
    {
        ...
        player.GetComponent<FrancScript>().wait_2();
    ...
    void PlayerAttack_Mob()
    {
        ...
        player.GetComponent<FrancScript>().attack();
    ...
    void PlayerAttack_Boss()
    {
        ...
        player.transform.DOLocalMoveY(-200, 0.3f).SetEase(Ease.OutBack); //이동 속도 관련 //공격이동 0.3   #9
        ...
        if (Boss.GetComponent<NimpueScript>().HP <= 0)
        {
            Enemy_HPbar.fillAmount = Boss.GetComponent<NimpueScript>().HP / Boss_HPMax;
            Invoke("EnemyReset", 0.6f);
            Invoke("skeletonMark", 0.6f);
    ...
    void resetposition() //#12 전체 위치값 초기화용
    {
        ...
        player.transform.DOLocalMoveY(-200, 0.5f).SetEase(Ease.OutQuad);
        enemy.transform.DOLocalMoveX(630, 0.5f).SetEase(Ease.OutQuad);
        Boss.transform.DOLocalMoveX(720, 0.5f).SetEase(Ease.OutQuad);       //#004
    }
    ...
    {
        Debug.Log("페이스");
        Battle_Cut_Face.transform.DOLocalMoveX(1.2f, 1f);
        Battle_Cut_Emblem.transform.DOLocalMoveX(80.0f, 1f);
    }
    ...
    void SkiilAttack_Boss()
    {
        ...
        Boss.SetActive(true);
        player.SetActive(true);
        player.GetComponent<FrancScript>().skill_1();
        Skilleffect_1.Play();
    ...
    void SkillSecondMove()
    {
        ...
        player.transform.DOLocalMoveY(-200, 0.3f); //스킬공격 모션Y
    }
    void SkillSecondMotion()
    {
        Debug.Log("스킬2번 사용");
        player.GetComponent<FrancScript>().skill_2();
    }
    ...
    {
        Boss.transform.DOLocalMoveX(720, 0.8f);  //##004
    ...
    void SkilleffectOut() //스킬이펙트 종료
    {
        ...
        Skilleffect_2.Stop();
        resetposition();
        player.GetComponent<FrancScript>().ResetWait_1();
    }
    void EnemyAttack_Mob()  //#14
    {
        ...
        Invoke("_camera", 0.2f);
        player.GetComponent<FrancScript>().damage();
        player.GetComponent<FrancScript>().HP = player.GetComponent<FrancScript>().HP - enemyDamage; //피격시 대미지 계산후 아군 캐릭터 HP 감소
    ...
    void EnemyAttack_Boss()
    {
        ...
        Boss.GetComponent<NimpueScript>().attack();
        Boss.transform.DOLocalMoveX(-100, 0.3f).SetEase(Ease.OutBack); //이동 속도 관련 //공격이동 0.3
        Invoke("_camera", 0.2f);
        player.GetComponent<FrancScript>().damage();
        player.GetComponent<FrancScript>().HP = player.GetComponent<FrancScript>().HP - _enemyDamage; //피격시 대미지 계산후 아군 캐릭터 HP 감소
        player.transform.DOLocalMoveX(-735, 0.8f);
