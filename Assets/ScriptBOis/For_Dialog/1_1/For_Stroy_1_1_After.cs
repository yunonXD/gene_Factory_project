...
public class For_Stroy_1_1_After : MonoBehaviour
{
    ...
    public void ForStory_1_1_After()
    {
        ...
        switch (CountClick)
        {
            ...
            case 7:
                _name.text = "마리아";
                _index.DOText("현재 저희가 싸우고 있는 괴물들은 조합 기술 입자에 노출된 생명체를 말합니다.", 1);
                break;
            ...
            case 8:
                _name.text = "마리아";
                _index.DOText("그중에서도 생명체가 조합되면서 강력한 힘을 가진 생명체는 개인 능력치가 매우 뛰어났습니다.", 1);
                break;

            case 9:
                _name.text = "마리아";
                _index.DOText("괴물들은, 기본적으로 인간들을 적대하며 인간들을 무차별로 공격했습니다.", 1);
                break;
            case 10:
                _name.text = "마리아";
